...
var WAVENERD_DECK=(()=>{var y=Object.defineProperty;var I=Object.getOwnPropertyDescriptor;var U=Object.getOwnPropertyNames;var O=Object.prototype.hasOwnProperty;var G=(i,e,r)=>e in i?y(i,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):i[e]=r;var H=(i,e)=>{for(var r in e)y(i,r,{get:e[r],enumerable:!0})},X=(i,e,r,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of U(e))!O.call(i,a)&&a!==r&&y(i,a,{get:()=>e[a],enumerable:!(t=I(e,a))||t.enumerable});return i};var Y=i=>X(y({},"__esModule",{value:!0}),i);var n=(i,e,r)=>(G(i,typeof e!="symbol"?e+"":e,r),r);var p=(i,e,r)=>new Promise((t,a)=>{var s=u=>{try{_(r.next(u))}catch(m){a(m)}},o=u=>{try{_(r.throw(u))}catch(m){a(m)}},_=u=>u.done?t(u.value):Promise.resolve(u.value).then(s,o);_((r=r.apply(i,e)).next())});var J={};H(J,{BeatManager:()=>l,WavenerdDeck:()=>v,default:()=>V});var T=class{constructor(){n(this,"__eventListeners")}on(e,r){this.__eventListeners=this.__eventListeners||new Map;let t=this.__eventListeners.get(e);return t||(t=[],this.__eventListeners.set(e,t)),t.push(r),r}off(e,r){this.__eventListeners=this.__eventListeners||new Map;let t=this.__eventListeners.get(e);t||(t=[],this.__eventListeners.set(e,t));let a=t.indexOf(r);a!==-1&&t.splice(a,1)}__emit(...[e,r]){var t;this.__eventListeners=this.__eventListeners||new Map,(t=this.__eventListeners.get(e))==null||t.forEach(a=>a(r))}};function B(i,e){e.forEach(r=>{Object.getOwnPropertyNames(r.prototype).forEach(t=>{Object.defineProperty(i.prototype,t,Object.getOwnPropertyDescriptor(r.prototype,t))})})}function S(i,e){return i-Math.floor(i/e)*e}var l=class{constructor(){n(this,"__bpm",140);n(this,"__time",0);n(this,"__beat",0);n(this,"__bar",0);n(this,"__sixteenBar",0)}static CalcBeatSeconds(e){return 60/e}static CalcBarSeconds(e){return 240/e}static CalcSixteenBarSeconds(e){return 3840/e}get bpm(){return this.__bpm}set bpm(e){let r=this.__bpm;this.__bpm=Math.max(0,e),this.__sixteenBar=this.__sixteenBar*r/this.__bpm,this.__emit("changeBPM",{bpm:this.__bpm})}get beatSeconds(){return l.CalcBeatSeconds(this.__bpm)}get barSeconds(){return l.CalcBarSeconds(this.__bpm)}get sixteenBarSeconds(){return l.CalcSixteenBarSeconds(this.__bpm)}get time(){return this.__time}get beat(){return this.__beat}get bar(){return this.__bar}get sixteenBar(){return this.__sixteenBar}reset(){this.__time=0,this.__sixteenBar=0}update(e){let r=l.CalcBeatSeconds(this.__bpm),t=l.CalcBarSeconds(this.__bpm),a=l.CalcSixteenBarSeconds(this.__bpm),s=e-this.__time;this.__sixteenBar=S(this.__sixteenBar+s,a),this.__bar=S(this.__sixteenBar,t),this.__beat=S(this.__bar,r),this.__time=e;let o={time:e,bpm:this.__bpm,beat:this.__beat,bar:this.__bar,sixteenBar:this.__sixteenBar};return this.__emit("update",o),o}};B(l,[T]);var C=`/* eslint-disable */
...
`;var Z=128,$=2,F=65536,q=new Blob([C],{type:"text/javascript"}),j=URL.createObjectURL(q),R=class extends AudioWorkletNode{constructor(r){super(r,"buffer-reader-processor",{numberOfInputs:0,numberOfOutputs:1,outputChannelCount:[$]});n(this,"__readBlocks");this.__readBlocks=0,this.port.onmessage=({data:t})=>{this.__readBlocks=t}}get readBlocks(){return this.__readBlocks}static addModule(r){return r.audioWorklet.addModule(j)}write(r,t,a,s){let o=F*r+Z*t%F+a;this.port.postMessage([s,o])}};var A=`#version 300 es
