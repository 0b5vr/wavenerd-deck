...
var WAVENERD_DECK=(()=>{var w=Object.defineProperty;var $=Object.getOwnPropertyDescriptor;var O=Object.getOwnPropertyNames;var W=Object.prototype.hasOwnProperty;var z=(s,t,e)=>t in s?w(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var G=(s,t)=>{for(var e in t)w(s,e,{get:t[e],enumerable:!0})},H=(s,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of O(t))!W.call(s,r)&&r!==e&&w(s,r,{get:()=>t[r],enumerable:!(n=$(t,r))||n.enumerable});return s};var X=s=>H(w({},"__esModule",{value:!0}),s);var a=(s,t,e)=>(z(s,typeof t!="symbol"?t+"":t,e),e);var d=(s,t,e)=>new Promise((n,r)=>{var i=c=>{try{l(e.next(c))}catch(u){r(u)}},o=c=>{try{l(e.throw(c))}catch(u){r(u)}},l=c=>c.done?n(c.value):Promise.resolve(c.value).then(i,o);l((e=e.apply(s,t)).next())});var rt={};G(rt,{BeatManager:()=>_,WavenerdDeck:()=>b,default:()=>et});var M=s=>[...Array(s)].map((t,e)=>e);var A=class{constructor(s){this.index=0,this.array=s}get current(){return this.array[this.index]}next(){return this.index=(this.index+1)%this.array.length,this.current}};var P=`#version 300 es
...
`).length,k=`void main() {
  ...
  outL = out2.x;
  outR = out2.y;
}`;function I(s){let t=s.fenceSync(s.SYNC_GPU_COMMANDS_COMPLETE,0);return new Promise((e,n)=>{let r=()=>{let i=s.clientWaitSync(t,0,0);if(i===s.WAIT_FAILED){n();return}if(i===s.TIMEOUT_EXPIRED){setTimeout(r,10);return}s.deleteSync(t),e()};r()})}function C(s,t,e,n={}){var m,y;let{extParallel:r,tfVaryings:i,tfBufferMode:o}=n,l=null,c=null,u=null;try{if(l=s.createShader(s.VERTEX_SHADER),s.shaderSource(l,t),s.compileShader(l),!s.getShaderParameter(l,s.COMPILE_STATUS))throw new Error((m=s.getShaderInfoLog(l))!=null?m:void 0);if(c=s.createShader(s.FRAGMENT_SHADER),s.shaderSource(c,e),s.compileShader(c),!s.getShaderParameter(c,s.COMPILE_STATUS))throw new Error((y=s.getShaderInfoLog(c))!=null?y:void 0);return u=s.createProgram(),s.attachShader(u,l),s.attachShader(u,c),i&&s.transformFeedbackVaryings(u,i,o!=null?o:s.SEPARATE_ATTRIBS),s.linkProgram(u),new Promise((h,f)=>{let g=()=>{var p;if(!r||s.getProgramParameter(u,r.COMPLETION_STATUS_KHR)===!0){s.getProgramParameter(u,s.LINK_STATUS)?h(u):(s.deleteProgram(u),f(new Error((p=s.getProgramInfoLog(u))!=null?p:void 0)));return}setTimeout(g,10)};g()})}catch(h){return s.deleteProgram(u),Promise.reject(h)}finally{s.deleteShader(c),s.deleteShader(l)}}var q=128,Y=128;function Z(s,t){let e=new Float32Array(M(t)),n=s.createBuffer();return s.bindBuffer(s.ARRAY_BUFFER,n),s.bufferData(s.ARRAY_BUFFER,e,s.STATIC_DRAW),s.bindBuffer(s.ARRAY_BUFFER,null),n}function L(s,t){let e=s.createBuffer();return s.bindBuffer(s.ARRAY_BUFFER,e),s.bufferData(s.ARRAY_BUFFER,t*Float32Array.BYTES_PER_ELEMENT,s.STREAM_READ),s.bindBuffer(s.ARRAY_BUFFER,null),e}function Q(s,t){let e=L(s,t),n=L(s,t),r=s.createTransformFeedback(),i=[new Float32Array(t),new Float32Array(t)];return{bufferL:e,bufferR:n,tf:r,dstArrays:i}}var T=class{constructor(t,e){a(this,"gl");a(this,"blocksPerRender");a(this,"useSync");a(this,"__extParallel");a(this,"__tfPool");a(this,"__offsetBuffer");a(this,"__program");a(this,"__programCue");this.blocksPerRender=e,this.gl=t,this.useSync=!1,this.__tfPool=new A(M(Y).map(()=>Q(t,this.framesPerRender))),this.__extParallel=t.getExtension("KHR_parallel_shader_compile"),this.__offsetBuffer=Z(t,this.framesPerRender),this.__program=null,this.__programCue=null}get framesPerRender(){return q*this.blocksPerRender}dispose(){let{gl:t}=this;t.deleteBuffer(this.__offsetBuffer);for(let{bufferL:e,bufferR:n,tf:r}of this.__tfPool.array)t.deleteBuffer(e),t.deleteBuffer(n),t.deleteTransformFeedback(r);t.deleteProgram(this.__program),t.deleteProgram(this.__programCue)}getNextTFPoolEntry(){return this.__tfPool.next()}compile(t){return d(this,null,function*(){let{gl:e}=this,n=yield C(e,P+t+k,`#version 300 es
void main(){discard;}`,{extParallel:this.__extParallel,tfVaryings:["outL","outR"]}).catch(r=>{throw this.__programCue=null,e.deleteProgram(this.__programCue),r});n!=null&&(this.__programCue=n)})}applyCue(){let{gl:t}=this;if(this.__programCue==null)return;let e=this.__program;this.__program=this.__programCue,e!=null&&t.deleteProgram(e),this.__programCue=null}uniform1f(t,e){let{gl:n,__program:r}=this;if(r==null)return;let i=n.getUniformLocation(r,t);n.useProgram(r),n.uniform1f(i,e),n.useProgram(null)}uniform4f(t,...e){let{gl:n,__program:r}=this;if(r==null)return;let i=n.getUniformLocation(r,t);n.useProgram(r),n.uniform4f(i,...e),n.useProgram(null)}uniformTexture(t,e,n){let{gl:r,__program:i}=this;if(i==null)return;let o=r.getUniformLocation(i,t);r.activeTexture(r.TEXTURE0+e),r.bindTexture(r.TEXTURE_2D,n),r.useProgram(i),r.uniform1i(o,e),r.useProgram(null)}render(t,e,n){let{gl:r,__program:i}=this,{bufferL:o,bufferR:l,tf:c}=t;if(i==null)return;let u=r.getAttribLocation(i,"off");r.bindBuffer(r.ARRAY_BUFFER,this.__offsetBuffer),r.enableVertexAttribArray(u),r.vertexAttribPointer(u,1,r.FLOAT,!1,0,0),r.useProgram(i),r.bindTransformFeedback(r.TRANSFORM_FEEDBACK,c),r.bindBufferRange(r.TRANSFORM_FEEDBACK_BUFFER,0,o,4*e,4*n),r.bindBufferRange(r.TRANSFORM_FEEDBACK_BUFFER,1,l,4*e,4*n),r.enable(r.RASTERIZER_DISCARD),r.beginTransformFeedback(r.POINTS),r.drawArrays(r.POINTS,e,n),r.endTransformFeedback(),r.disable(r.RASTERIZER_DISCARD),r.bindTransformFeedback(r.TRANSFORM_FEEDBACK,null),r.useProgram(null)}readBuffer(r){return d(this,arguments,function*({bufferL:t,bufferR:e,dstArrays:n}){let{gl:i}=this;this.useSync&&(yield I(i)),i.bindBuffer(i.ARRAY_BUFFER,t),i.getBufferSubData(i.ARRAY_BUFFER,0,n[0],0,this.framesPerRender),i.bindBuffer(i.ARRAY_BUFFER,null),i.bindBuffer(i.ARRAY_BUFFER,e),i.getBufferSubData(i.ARRAY_BUFFER,0,n[1],0,this.framesPerRender),i.bindBuffer(i.ARRAY_BUFFER,null)})}};var x=class{constructor(){a(this,"__eventListeners")}on(t,e){this.__eventListeners=this.__eventListeners||new Map;let n=this.__eventListeners.get(t);return n||(n=[],this.__eventListeners.set(t,n)),n.push(e),e}off(t,e){this.__eventListeners=this.__eventListeners||new Map;let n=this.__eventListeners.get(t);n||(n=[],this.__eventListeners.set(t,n));let r=n.indexOf(e);r!==-1&&n.splice(r,1)}__emit(...[t,e]){var n;this.__eventListeners=this.__eventListeners||new Map,(n=this.__eventListeners.get(t))==null||n.forEach(r=>r(e))}};function S(s,t){t.forEach(e=>{Object.getOwnPropertyNames(e.prototype).forEach(n=>{Object.defineProperty(s.prototype,n,Object.getOwnPropertyDescriptor(e.prototype,n))})})}function E(s,t){return s-Math.floor(s/t)*t}var _=class{constructor(){a(this,"__bpm",140);a(this,"__time",0);a(this,"__beat",0);a(this,"__bar",0);a(this,"__sixteenBar",0)}static CalcBeatSeconds(t){return 60/t}static CalcBarSeconds(t){return 240/t}static CalcSixteenBarSeconds(t){return 3840/t}get bpm(){return this.__bpm}set bpm(t){let e=this.__bpm;this.__bpm=Math.max(0,t),this.__sixteenBar=this.__sixteenBar*e/this.__bpm,this.__emit("changeBPM",{bpm:this.__bpm})}get beatSeconds(){return _.CalcBeatSeconds(this.__bpm)}get barSeconds(){return _.CalcBarSeconds(this.__bpm)}get sixteenBarSeconds(){return _.CalcSixteenBarSeconds(this.__bpm)}get time(){return this.__time}get beat(){return this.__beat}get bar(){return this.__bar}get sixteenBar(){return this.__sixteenBar}reset(){this.__time=0,this.__sixteenBar=0}update(t){let e=_.CalcBeatSeconds(this.__bpm),n=_.CalcBarSeconds(this.__bpm),r=_.CalcSixteenBarSeconds(this.__bpm),i=t-this.__time;this.__sixteenBar=E(this.__sixteenBar+i,r),this.__bar=E(this.__sixteenBar,n),this.__beat=E(this.__bar,e),this.__time=t;let o={time:t,bpm:this.__bpm,beat:this.__beat,bar:this.__bar,sixteenBar:this.__sixteenBar};return this.__emit("update",o),o}};S(_,[x]);var B=`/* eslint-disable */
...
*/
//# sourceMappingURL=wavenerd-deck.iife.min.js.map
