...
var D=Object.defineProperty;var N=(i,e,t)=>e in i?D(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var n=(i,e,t)=>(N(i,typeof e!="symbol"?e+"":e,t),t);var f=(i,e,t)=>new Promise((r,a)=>{var s=u=>{try{_(t.next(u))}catch(l){a(l)}},o=u=>{try{_(t.throw(u))}catch(l){a(l)}},_=u=>u.done?r(u.value):Promise.resolve(u.value).then(s,o);_((t=t.apply(i,e)).next())});var T=class{constructor(){n(this,"__eventListeners")}on(e,t){this.__eventListeners=this.__eventListeners||new Map;let r=this.__eventListeners.get(e);return r||(r=[],this.__eventListeners.set(e,r)),r.push(t),t}off(e,t){this.__eventListeners=this.__eventListeners||new Map;let r=this.__eventListeners.get(e);r||(r=[],this.__eventListeners.set(e,r));let a=r.indexOf(t);a!==-1&&r.splice(a,1)}__emit(...[e,t]){var r;this.__eventListeners=this.__eventListeners||new Map,(r=this.__eventListeners.get(e))==null||r.forEach(a=>a(t))}};function y(i,e){e.forEach(t=>{Object.getOwnPropertyNames(t.prototype).forEach(r=>{Object.defineProperty(i.prototype,r,Object.getOwnPropertyDescriptor(t.prototype,r))})})}function S(i,e){return i-Math.floor(i/e)*e}var m=class{constructor(){n(this,"__bpm",140);n(this,"__time",0);n(this,"__beat",0);n(this,"__bar",0);n(this,"__sixteenBar",0)}static CalcBeatSeconds(e){return 60/e}static CalcBarSeconds(e){return 240/e}static CalcSixteenBarSeconds(e){return 3840/e}get bpm(){return this.__bpm}set bpm(e){let t=this.__bpm;this.__bpm=Math.max(0,e),this.__sixteenBar=this.__sixteenBar*t/this.__bpm,this.__emit("changeBPM",{bpm:this.__bpm})}get beatSeconds(){return m.CalcBeatSeconds(this.__bpm)}get barSeconds(){return m.CalcBarSeconds(this.__bpm)}get sixteenBarSeconds(){return m.CalcSixteenBarSeconds(this.__bpm)}get time(){return this.__time}get beat(){return this.__beat}get bar(){return this.__bar}get sixteenBar(){return this.__sixteenBar}reset(){this.__time=0,this.__sixteenBar=0}update(e){let t=m.CalcBeatSeconds(this.__bpm),r=m.CalcBarSeconds(this.__bpm),a=m.CalcSixteenBarSeconds(this.__bpm),s=e-this.__time;this.__sixteenBar=S(this.__sixteenBar+s,a),this.__bar=S(this.__sixteenBar,r),this.__beat=S(this.__bar,t),this.__time=e;let o={time:e,bpm:this.__bpm,beat:this.__beat,bar:this.__bar,sixteenBar:this.__sixteenBar};return this.__emit("update",o),o}};y(m,[T]);var F=`/* eslint-disable */
...
`;var G=128,H=2,C=65536,X=new Blob([F],{type:"text/javascript"}),Y=URL.createObjectURL(X),R=class extends AudioWorkletNode{constructor(t){super(t,"buffer-reader-processor",{numberOfInputs:0,numberOfOutputs:1,outputChannelCount:[H]});n(this,"__readBlocks");this.__readBlocks=0,this.port.onmessage=({data:r})=>{this.__readBlocks=r}}get readBlocks(){return this.__readBlocks}static addModule(t){return t.audioWorklet.addModule(Y)}setActive(t){this.port.postMessage(t)}write(t,r,a,s){let o=C*t+G*r%C+a;this.port.postMessage([s,o])}};var A=`#version 300 es
